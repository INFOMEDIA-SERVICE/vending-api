...
class ServicesRepository {
    ...
    public create = async(service: IService): Promise<IQueryResponse> => {
        ...
        return database.query(
            `insert into ${this.table}(user_id, machine_id, products, reference, value, success) values('${service.user_id}', '${service.machine_id}', '${service.products}', nextval('serial'), ${service.value}, ${service.success}) RETURNING *`
        ).then((value) => {
