...
class AdminController {
    constructor() {
        ...
        this.login = (req, res) => __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield repository_1.adminsRepository.login(email);
            if (response.ok) {
        ...
        this.getAll = (req, res) => __awaiter(this, void 0, void 0, function* () {
            const response = yield repository_1.adminsRepository.getAll();
            if (response.ok) {
        ...
        this.getById = (req, res) => __awaiter(this, void 0, void 0, function* () {
            const response = yield repository_1.adminsRepository.getById(req.params.id);
            if (response.ok) {
                delete response.data.password;
                res.send({
                    ok: true,
        ...
        this.me = (req, res) => __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield repository_1.adminsRepository.getById(user.id);
            if (response.ok) {
                delete response.data.password;
                res.send({
                    ok: true,
        ...
        this.update = (req, res) => __awaiter(this, void 0, void 0, function* () {
            const response = yield repository_1.adminsRepository.update(req.params.id, req.body);
            if (response.ok) {
                res.send({
                    ok: true,
                    user: response.data
        ...
        this.delete = (req, res) => __awaiter(this, void 0, void 0, function* () {
            const response = yield repository_1.adminsRepository.delete(req.params.id);
            if (response.ok) {
                res.send({
                    ok: true,
