...
// ADMIN
router.get('/', [auth_controller_1.authController.validateAdminToken], services_controller_1.servicesController.getAll);
...
router.get('/users/:id', [auth_controller_1.authController.validateAdminToken], services_controller_1.servicesController.getServicesByUser);
