...
class UserController {
    constructor() {
        ...
        this.login = (req, res) => __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield repository_1.usersRepository.login(email);
            if (response.ok) {
        ...
        this.getAll = (req, res) => __awaiter(this, void 0, void 0, function* () {
            const response = yield repository_1.usersRepository.getAll();
            if (response.ok) {
        ...
        this.me = (req, res) => __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield repository_1.usersRepository.getById(user.id);
            if (response.ok) {
                delete response.data.password;
                res.send({
                    ok: true,
        ...
        this.getById = (req, res) => __awaiter(this, void 0, void 0, function* () {
            const response = yield repository_1.usersRepository.getById(req.params.id);
            if (response.ok) {
                delete response.data.password;
                res.send({
                    ok: true,
        ...
        this.update = (req, res) => __awaiter(this, void 0, void 0, function* () {
            const response = yield repository_1.usersRepository.update(req.params.id, req.body);
            if (response.ok) {
                res.send({
                    ok: true,
                    user: response.data
        ...
        this.updateStatus = (req, res) => __awaiter(this, void 0, void 0, function* () {
            const response = yield repository_1.usersRepository.updateStatus(req.params.id, req.body);
            if (response.ok) {
                res.send({
                    ok: true,
                    user: response.data
        ...
        this.delete = (req, res) => __awaiter(this, void 0, void 0, function* () {
            const response = yield repository_1.usersRepository.delete(req.params.id);
            if (response.ok) {
                res.send({
                    ok: true,
