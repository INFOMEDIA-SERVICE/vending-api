...
class UserController {
    constructor() {
        ...
        this.getById = (req, res) => __awaiter(this, void 0, void 0, function* () {
            const response = yield user_repository_1.usersRepository.getById(parseInt(req.params.id));
            if (response.ok) {
                delete response.data.password;
                res.send({
                    ok: true,
        ...
        this.update = (req, res) => __awaiter(this, void 0, void 0, function* () {
            const response = yield user_repository_1.usersRepository.update(parseInt(req.params.id), req.body);
            if (response.ok) {
                res.send({
                    ok: true,
                    user: response.data
        ...
        this.delete = (req, res) => __awaiter(this, void 0, void 0, function* () {
            const response = yield user_repository_1.usersRepository.delete(parseInt(req.params.id));
            if (response.ok) {
                res.send({
                    ok: true,
